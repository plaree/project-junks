...
for contour in contours:
    ...
    x,y,w,h = cv2.boundingRect(contour) # Konturun etrafını saran dikdörtgenin özelliklerini al
    aspect_ratio = float(w)/h # Genişlik ve yükseklik oranı
    if area > 333 and aspect_ratio > 0.5: # Kontur alanı ve genişlik/yükseklik oranı eşik değerlerimizden büyükse, bir araba olarak kabul edilir
        number_of_cars += 1
